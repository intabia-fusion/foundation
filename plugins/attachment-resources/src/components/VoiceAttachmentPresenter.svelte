...
<script lang="ts">
  ...
  import { Button, ButtonIcon, IconClose, IconEdit, Spinner } from '@hcengineering/ui'
  import view from '@hcengineering/view'
  import activity from '@hcengineering/activity'
  import VoicePlayer from './VoicePlayer.svelte'
  import StyledTextEditor from '@hcengineering/text-editor-resources/src/components/StyledTextEditor.svelte'
...
<div class="voice" class:editing>
  ...
  {#if state === 'pending'}
    <div class="status"><Spinner size="x-small" /> transcribing…</div>
  {:else if state === 'failed'}
    <div class="status error-color">transcription failed</div>
  {:else if editing}
    <div class="editor">
